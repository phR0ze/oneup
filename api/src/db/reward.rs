...
/// - error on other SQL errors
pub(crate) async fn fetch_by_id(db: &SqlitePool, id: i64) -> errors::Result<model::Reward> {
...
pub(crate) async fn fetch_by_user_id(db: &SqlitePool, user_id: i64) -> errors::Result<Vec<model::Reward>> {
  super::user::fetch_by_id(db, user_id).await?;
...
/// - error on other SQL errors
/// - ***user_id*** owner of the points
pub(crate) async fn fetch_all(db: &SqlitePool) -> errors::Result<Vec<model::Reward>> {
